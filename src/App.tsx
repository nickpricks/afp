...
const InviteRedeem = lazy(() =>
  import('@/shared/auth/InviteRedeem').then((m) => ({ default: m.InviteRedeem })),
);
const AdminPanel = lazy(() =>
  import('@/admin/components/AdminPanel').then((m) => ({ default: m.AdminPanel })),
);
const InviteGenerator = lazy(() =>
  import('@/admin/components/InviteGenerator').then((m) => ({ default: m.InviteGenerator })),
);
const DebugPage = lazy(() =>
  import('@/shared/components/DebugPage').then((m) => ({ default: m.DebugPage })),
);
const ProfilePage = lazy(() =>
  import('@/shared/components/ProfilePage').then((m) => ({ default: m.ProfilePage })),
);
const BodyPage = lazy(() =>
  import('@/modules/body/components/BodyPage').then((m) => ({ default: m.BodyPage })),
);
const ExpenseListPage = lazy(() =>
  import('@/modules/expenses/pages/ExpenseListPage').then((m) => ({ default: m.ExpenseListPage })),
);
const AddExpensePage = lazy(() =>
  import('@/modules/expenses/pages/AddExpensePage').then((m) => ({ default: m.AddExpensePage })),
);
const BabyLanding = lazy(() =>
  import('@/modules/baby/components/BabyLanding').then((m) => ({ default: m.BabyLanding })),
);
const ChildDetail = lazy(() =>
  import('@/modules/baby/components/ChildDetail').then((m) => ({ default: m.ChildDetail })),
);
const Dashboard = lazy(() =>
  import('@/shared/components/Dashboard').then((m) => ({ default: m.Dashboard })),
);
const AnimationViewer = lazy(() =>
  import('@/shared/components/AnimationViewer').then((m) => ({ default: m.AnimationViewer })),
);
