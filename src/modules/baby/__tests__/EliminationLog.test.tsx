...
vi.mock('@/modules/baby/hooks/useBabyData', () => ({
  useBabyData: () => ({
    ...
    logFeed: vi.fn(), updateFeed: vi.fn(), removeFeed: vi.fn(),
    logSleep: vi.fn(), updateSleep: vi.fn(), removeSleep: vi.fn(),
    logGrowth: vi.fn(), updateGrowth: vi.fn(), removeGrowth: vi.fn(),
    logDiaper: vi.fn(), updateDiaper: vi.fn(), removeDiaper: vi.fn(),
