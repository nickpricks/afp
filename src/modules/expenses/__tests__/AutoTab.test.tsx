...
/** Validates AutoTab shows BudgetMsg.AmountRequired toast on submit with blank amount */
describe('AutoTab — amount validation toast', () => {
  it('shows AmountRequired (not CategoryRequired) toast when amount is blank on submit', async () => {
    ...
    // Submit with blank amount — should show AmountRequired, NOT CategoryRequired
