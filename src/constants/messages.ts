...
export enum BabyMsg {
  ...
  MealDescriptionRequired = 'Description required',
  NeedAdded = 'Added to wishlist',
  NeedDeleted = 'Need deleted',
  NeedUpdated = 'Need updated',
  NeedMovedToInventory = 'Moved to inventory',
  NeedMovedToOutgrown = 'Moved to outgrown',
  NeedTitleRequired = 'Need title required',
  MilestoneAdded = 'Milestone logged',
  MilestoneDeleted = 'Milestone deleted',
  MilestoneUpdated = 'Milestone updated',
  MilestoneTitleRequired = 'Milestone title required',
