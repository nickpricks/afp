...
- [x] **Step 1: Rename directory (optional) or keep as-is with ModuleId.Budget**
...
- [x] **Step 2: Update Expense type with paymentMethod and isSettlement**
...
- [x] **Step 3: Update categories to use numeric ExpenseCategory enum**
...
- [x] **Step 4: Add IncomeSource labels**
...
- [x] **Step 5: Add PaymentMethod labels**
...
- [x] **Step 1: Implement useIncome hook**
...
- [x] **Step 1: Add payment method bubble selector**
...
- [x] **Step 1: Build reconciliation filter/group view**
...
- [x] **Step 2: Wire into Budget landing as a filter mode**
...
- [x] **Step 1: Test smart totals (settlements excluded)**
...
- [x] **Step 2: Update validation tests for numeric enums**
